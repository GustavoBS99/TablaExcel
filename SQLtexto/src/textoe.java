...
public class textoe {
    ...
    public static void main(String[] args) throws Exception {
        ...
        File arch = new File("C:\\Users\\Carolina\\Desktop\\SQL.txt");
        ...
        for (int j = 1; j < txtar.length; j++) {
            if (txtar[j][0].contains("stu")) {
                txtar[j][0] = "Students";
            }
            if (txtar[j][0].contains("com")) {
                txtar[j][0] = "Comments";
            }
        }
        ...
        crearExcel("C:\\Users\\Carolina\\Desktop\\SQL.xls", "SQL", txtar);
    }
